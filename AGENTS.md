Your task is to write a good Sublime Text syntax for the Dart programming language.

The syntax is in package/Dart.sublime-syntax. I have added some scaffolding but other than comments and the shebang there's not much done.

These files will help you do that, read them all:

- support/plaintext_grammar.txt: Contains the full specification of the Dart grammar. Keep in mind you already know how to write Dart, and a syntax and a grammar are different things. You need to assign scopes to positions, not validate if the user is writing "void" where it shouldn't.
